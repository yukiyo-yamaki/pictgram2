...
public class SocialUser implements OidcUser, OAuth2User, UserInf {
	...
	public SocialUser(Collection<? extends GrantedAuthority> authorities, OidcIdToken idToken, OidcUserInfo userInfo, Long userId) {
		this.oauth2User = new DefaultOidcUser(authorities, idToken, userInfo);
		this.userId = userId;
	}
	
	public SocialUser(Collection<? extends GrantedAuthority> authorities, Map<java.lang.String, java.lang.Object> 
	attributes, String nameAttributeKey, Long userId) {
